...
//----select package summary page elements----------------
	...
	@FindBy(xpath = "(//table/tbody/tr[1])[3]")
	private WebElement disconnectStatusRow;
...
//--------------------Bulk---------------
	...
	{
		waitTillElementIsClickable(disconnectButtonSummaryPage);
...
//		}
		...
		disconnectPack();
		Thread.sleep(3000);
		waitTillElementIsVisible(disconnectStatusRow);
		...
		logger.info(disconnectStatusRow.getText());
