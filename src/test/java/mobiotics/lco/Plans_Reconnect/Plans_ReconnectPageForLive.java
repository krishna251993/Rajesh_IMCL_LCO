...
static final Logger logger=Logger.getLogger(Plans_ReconnectPageForLive.class);
	...
	@FindBy(xpath = "//button[@id='bulkReconnectbutton']")
...
//	private WebElement reconnnectBtnR1;
	...
	@FindBy(xpath = "(//table[@class='table table-striped']/tbody/tr[1])[2]")
	private WebElement reconnectStatusResult;
	
	@FindBy(xpath = "//input[@type='file']")
	private WebElement fileUploadFld;
	...
	public void testReconnectPlans_Single() throws InterruptedException {
		...
		else
		{
			...
			logger.info(reconnectStatusResult.getText());
		}
	...
	public void reconnectPlan_Bulk() throws IOException, InterruptedException {
		...
		bulkReconnect.click();
		Thread.sleep(10000);
		//waitTillElementIsVisible(fileUploadFld);
		fileUploadFld.sendKeys(System.getProperty("user.dir")+"/ExcelPages/BulkReconnect.csv");
		uploadBtn.click();
		Thread.sleep(2000);
